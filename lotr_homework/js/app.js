...
const forgeTheFellowShip = () => {
  ...
  const $divFellowship = $('<div>');
  $divFellowship.attr('id', 'the-fellowship');
  ...
  const $hobbitUl = $('#Rivendell').children('ul');
  $('#the-fellowship').append($hobbitUl);

  const $buddyUl = $('aside').children('ul');
